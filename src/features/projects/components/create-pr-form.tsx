    ...
    return (
        <Card className="size-full border-none shadow-none sm:bg-slate-800">
            <CardHeader className="flex p-7">
                <CardTitle className="text-xl font-bold">Create a pull request</CardTitle>
            </CardHeader>
            <div className="px-7">
                <DottedSeparator />
            </div>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input {...field} placeholder="Enter branch name" className="border border-slate-50" />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Textarea {...field} placeholder="Enter pull request description" className="border border-slate-50" />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
